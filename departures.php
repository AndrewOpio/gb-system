<?php
    ...
    require_once "classes/departures.php";
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $insert = $departure->addDeparture($v_id, $pnumber, $to, $fnumber, $reason, $ddate);
                        ...
                        <div class="col-12">
                            <div class="card">                   
                                <div class="card-header" style="height: 60px; background-color: blue;">
                                    <h4 style="color: white;"><a href = "home.php"  style="color: white; padding-right: 30px; "><i class="fas fa-arrow-left"></i></a>Adicionar novas partidas</h4>
                                </div>
                                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                    <div class="card-body">
                                        <div class = "row">
                                            <div class = "col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <input type = "text" autocomplete = "off" name = "pnumber" id = "pnumber" class="form-control" value = "<?php if (isset($_GET["number"])) { echo $_GET["number"]; }?>" placeholder = "insira o número do passaporte.." required/>
                                        ...
                                        <button class = "btn btn-primary" style = "float:right; width: 200px; margin-bottom: 20px;">+ Adicionar partida</button>
                                    </div>
                                </form>
                            </div>
                        </div>
