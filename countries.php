<?php
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST"){
     if (isset($_POST["add"])) {
        ...
        $check = $country->checkDetails($name, $code);
        $get = pg_fetch_object($check);
        
        if (!$get) {
            $insert = $country->addCountry($name, $code);
        ...
        if ($name_orig != $name || $code_orig != $code) {
            if ($name_orig != $name) {
                $check = $country->checkEditDetails($name, "");

            } else {
                $check = $country->checkEditDetails("", $code);
            }            
            $get = pg_fetch_object($check);
        ...
        if (!$get) {
            $edit = $country->editCountry($name, $code, $id);
                        ...
                        <div class="col-12" style="margin: auto;">
                            <div class="card">                   
                                <div class="card-header" style="height: 60px; background-color: blue;">
                                    <h4 style="color: white;"><a href = "home.php"  style="color: white; padding-right: 30px;"><i class="fas fa-arrow-left"></i></a>Novo país</h4>
                                    <button type = "submit" class="btn btn-success" data-toggle="modal" data-target="#add" data-backdrop = "true" style="margin-top: -38px; float: right;"><i class="fas fa-plus"></i>  Adicionar País</button>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Adicionar País</h4>
                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive" style="padding-top: 10px;">
                                        <table class="table table-striped" id="table-6">
                                            ...
                                            <?php
                                                $i = 1;
                                                $query = $country->getCountries();
                                                while($data = pg_fetch_object($query)){                                                    
                                            ?>  
                                                <div id="country<?php echo $i;?>" class="modal fade" role="dialog">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <!-- Modal content-->
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                                                    <div class="card-body">
                                                                        <label>Nome do país:</label>
                                                                        <div class="form-group">
                                                                            <input type = "text" name = "name" class="form-control" value="<?php echo $data->countryname; ?>"  placeholder = "insira o nome.." required/>
                                                                            <input type = "hidden" name = "name_orig" value="<?php echo $data->countryname; ?>"/>
                                                                        </div>
                                                                        
                                                                        <label>Código do país:</label> 
                                                                        <div class="form-group">
                                                                           <input type = "text" name = "code" class="form-control" value="<?php echo $data->countrycode; ?>" placeholder = "Coloque o código.." required/>
                                                                           <input type = "hidden" name = "code_orig" value="<?php echo $data->countrycode; ?>"/>
                                                                        </div>
                                                ...
                                                <div id="delete<?php echo $i;?>" class="modal fade" role="dialog">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Excluir este país</h4>
                                                            </div>
                                                            <div class="modal-body">
                                                                <p>Tem certeza de que deseja excluir este país?</p>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <button  type = "button" class="dropdown-item has-icon" data-toggle="modal" data-target="#country<?php echo $i;?>" data-backdrop = "true"><i class="fas fa-edit"></i>  Editar</button>
